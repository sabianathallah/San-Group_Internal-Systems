    ...
    sections: [
      ...
      },
      {
        ...
        tips: [
          ...
          '**Dibagikan ke Saya**: task orang lain yang dibagikan ke kamu — bukan task milikmu sendiri.',
      ...
      },
      {
        ...
        tips: [
          ...
          'Dropdown **Group by** (List & Board) bisa kelompokkan task berdasarkan Status, Prioritas, Assignee, atau **Proyek** — pilihan "Proyek" mengelompokkan per List/Project, lengkap dengan hitungan "Selesai x/y" di tiap kelompok, mirip tampilan "By Project" di Notion.',
    ...
    sections: [
      ...
      },
      {
        ...
        tips: [
          ...
          '**Shared with Me**: tasks others shared with you — not your own.',
      ...
      },
      {
        ...
        tips: [
          ...
          'The **Group by** dropdown (List & Board) lets you group tasks by Status, Priority, Assignee, or **Project** — the "Project" option groups by List/Project, with a "Complete x/y" count per group, similar to Notion\'s "By Project" view.',
