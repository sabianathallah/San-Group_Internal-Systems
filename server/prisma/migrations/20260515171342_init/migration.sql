-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'OWNER', 'DIRECTOR', 'PROPERTY_MANAGER', 'LEASING_MANAGER', 'LEASING_ASSISTANT', 'LEASING_STAFF', 'TENANT_RELATIONS', 'FACILITY_MANAGER', 'CHIEF_ENGINEER', 'ENGINEER', 'FINANCE_MANAGER', 'ASST_FINANCE_MANAGER', 'ACCOUNTANT', 'LEGAL_HEAD', 'LEGAL_SPV', 'LEGAL_STAFF', 'TAX_STAFF', 'HR_MANAGER', 'HR_SPV', 'HR_STAFF', 'FNB_MANAGER', 'GA_MANAGER', 'STAFF');

-- CreateEnum
CREATE TYPE "Division" AS ENUM ('MANAGEMENT', 'RETAIL', 'HOTEL', 'HOUSING', 'FNB', 'GENERAL', 'LEASING', 'PROPERTY', 'ENGINEERING', 'FINANCE', 'LEGAL', 'TAX', 'HR', 'GA');
