...
import {
  ...
  updateWorkOrder, changeWorkOrderStatus, reviewWorkOrder, addWorkOrderAttachment,
  deleteWorkOrder, getWorkOrderStats, getWorkOrderReports,
...
import {
  createWorkOrderSchema, updateWorkOrderSchema, changeStatusSchema, reviewWorkOrderSchema,
  addAttachmentSchema, workOrderFilterSchema, workOrderReportsFilterSchema,
...
router.get('/reports', checkPerm('work_order', 'view'), validate(workOrderReportsFilterSchema, ['query']), getWorkOrderReports);
...
router.patch('/:id/review', checkPerm('work_order', 'edit'), validate(uuidParamSchema, ['params']), validate(reviewWorkOrderSchema), reviewWorkOrder);
router.post('/:id/attachments', checkPerm('work_order', 'edit'), validate(uuidParamSchema, ['params']), validate(addAttachmentSchema), addWorkOrderAttachment);
